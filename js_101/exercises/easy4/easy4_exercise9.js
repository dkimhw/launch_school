...
Considerations:
- Words consist of any sequence of non-space characters and non-letters (a-z)
...
function wordSizes(str) {
    let cleanedStr = str.replace(/W_+/, '');
    let strArray = cleanedStr.split(' '); // words are non-space characters
